...
type (
	...
	PhoneCodeCooldownError     = auth.PhoneCodeCooldownError
	...
	WeChatSettingRequest       = auth.WeChatSettingRequest
	PublicWeChatSetting        = auth.PublicWeChatSetting
	DouyinSettingRequest       = auth.DouyinSettingRequest
	PublicDouyinSetting        = auth.PublicDouyinSetting
	SocialLoginCallbackResult  = auth.SocialLoginCallbackResult
...
func (s *Service) SMSVerificationRequired() (bool, error) {
	return s.authDomain().SMSVerificationRequired()
}
...
func (s *Service) SendRegistrationPhoneCode(rawPhone string) error {
	return s.authDomain().SendRegistrationPhoneCode(rawPhone)
}

func (s *Service) SendRegistrationPhoneCodeContext(ctx context.Context, rawPhone string) error {
	return s.authDomain().SendRegistrationPhoneCodeContext(ctx, rawPhone)
}

func (s *Service) VerifyRegistrationPhoneCode(phone string, rawCode string) (*model.PhoneVerificationCode, error) {
	return s.authDomain().VerifyRegistrationPhoneCode(phone, rawCode)
}

func NormalizePhone(value string) string {
	return auth.NormalizePhone(value)
}
