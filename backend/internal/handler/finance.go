...
func RegisterFinanceRoutes(r *gin.RouterGroup, svc *service.Service) {
	...
	r.GET("/admin/settings/wechat", func(c *gin.Context) {
		user, err := currentUser(c, svc)
		if err != nil {
			failService(c, err)
			return
		}
		setting, err := svc.AdminWeChatSetting(user)
		if err != nil {
			failService(c, err)
			return
		}
	...
	r.PATCH("/admin/settings/wechat", func(c *gin.Context) {
		user, err := currentUser(c, svc)
		if err != nil {
			failService(c, err)
			return
		}
		var req service.WeChatSettingRequest
		if err := c.ShouldBindJSON(&req); err != nil {
			fail(c, http.StatusBadRequest, err)
			return
		}
		setting, err := svc.UpdateWeChatSetting(user, req)
		if err != nil {
			failService(c, err)
			return
		}
	...
	r.GET("/admin/settings/douyin", func(c *gin.Context) {
		user, err := currentUser(c, svc)
		if err != nil {
			failService(c, err)
			return
		}
		setting, err := svc.AdminDouyinSetting(user)
		if err != nil {
			failService(c, err)
			return
		}
	...
	r.PATCH("/admin/settings/douyin", func(c *gin.Context) {
		user, err := currentUser(c, svc)
		if err != nil {
			failService(c, err)
			return
		}
		var req service.DouyinSettingRequest
		if err := c.ShouldBindJSON(&req); err != nil {
			fail(c, http.StatusBadRequest, err)
			return
		}
		setting, err := svc.UpdateDouyinSetting(user, req)
		if err != nil {
			failService(c, err)
			return
		}
