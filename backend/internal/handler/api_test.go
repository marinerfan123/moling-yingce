...
func TestRegisterCanvasAPIExposesOpenAPIAndProjects(t *testing.T) {
	...
	wanted := map[string]bool{
		...
		"POST /api/auth/phone-code":       false,
		"GET /api/admin/settings/sms":     false,
		"PATCH /api/admin/settings/sms":   false,
	}
	...
	if recorder.Code != http.StatusOK || !strings.Contains(recorder.Body.String(), "openapi: 3.0.3") || !strings.Contains(recorder.Body.String(), "url: /api") || !strings.Contains(recorder.Body.String(), "/admin/settings/sms") {
