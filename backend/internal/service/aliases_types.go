...
type (
	...
	AdminChannelExport                     = app.AdminChannelExport
	AdminChannelExportChannel              = app.AdminChannelExportChannel
	AdminChannelExportModel                = app.AdminChannelExportModel
	AdminChannelExportPriceTier            = app.AdminChannelExportPriceTier
	AdminChannelImportRequest              = app.AdminChannelImportRequest
	AdminChannelImportResult               = app.AdminChannelImportResult
	...
	PhoneCodeCooldownError                 = app.PhoneCodeCooldownError
	...
	PublicWeChatSetting                    = app.PublicWeChatSetting
	PublicDouyinSetting                    = app.PublicDouyinSetting
	...
	WeChatSettingRequest                   = app.WeChatSettingRequest
	DouyinSettingRequest                   = app.DouyinSettingRequest
	SocialLoginCallbackResult              = app.SocialLoginCallbackResult
