...
const LocalToolsPage = lazy(() => import("@/pages/admin/local-tools/local-tools-page"));
...
export const router = createBrowserRouter([
    ...
    ...(import.meta.env.DEV ? devRoutes() : []),
    {
        ...
        children: [
            ...
            {
                path: "/admin",
                element: <RequireAdmin>{deferred(<AdminPage />)}</RequireAdmin>,
                children: [
                    { index: true, element: <AnalyticsPage /> },
                    { path: "users", element: <UsersPage /> },
                    { path: "channels", element: <ChannelsPage /> },
                    { path: "local-tools", element: <LocalToolsPage /> },
