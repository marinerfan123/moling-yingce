...
export default function SharedCanvasPage() {
    ...
    useEffect(() => {
        ...
        getPublicCanvasShare(token).then(({ project }) => {
            ...
            setNodes(visibleCanvasNodesForUser(project.nodes || [], false).map(ensureMediaNodeMinimumSize));
            setConnections(visibleCanvasConnectionsForUser(project.nodes || [], project.connections || [], false));
