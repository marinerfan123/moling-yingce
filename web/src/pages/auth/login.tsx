...
import { ArrowRight, LockKeyhole, MessageCircle, Music2, UserRound } from "lucide-react";
import { Link, useNavigate, useSearchParams } from "react-router";

import { douyinLoginURL, getAuthSession, getAuthSettings, linuxDOLoginURL, login, weChatLoginURL } from "@/services/api/auth";
...
export default function LoginPage() {
    ...
    const [douyinEnabled, setDouyinEnabled] = useState(false);
    ...
    useEffect(() => {
        void getAuthSettings()
            .then((settings) => {
                ...
                setWechatEnabled(settings.wechatEnabled);
                setDouyinEnabled(settings.douyinEnabled);
            })
            .catch((error) => {
    ...
    return (
        <form onSubmit={submit} className="space-y-5">
            ...
            {linuxdoEnabled || wechatEnabled || douyinEnabled ? (
                <>
