...
export default function TasksPage() {
    ...
    const isAdmin = useUserStore((state) => canUseDesktopLocalTools(state.user, state.features.desktopLocalChannelsEnabled));
    ...
    const loadTasks = useCallback(async (showLoading = false) => {
        ...
        try {
            const next = await listGenerationTasks(30, { includeLocal: isAdmin });
    ...
    }, [isAdmin, message, syncCompletedCanvasTasks]);
