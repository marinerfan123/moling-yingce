...
const adminNavigation: Array<{ label: string; items: AdminNavigationItem[] }> = [
    ...
    },
    {
        ...
        items: [
            ...
            { path: "/admin/local-tools", label: "本机工具", description: "Runtime、CLI 与 Bridge", icon: <MonitorUp className="size-4" /> },
    ...
    },
    {
        ...
        items: [
            ...
            { path: "/admin/settings/access", label: "登录与注册", description: "账号创建、手机验证与第三方登录", icon: <ShieldCheck className="size-4" /> },
