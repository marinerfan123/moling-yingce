...
export type SocialLoginSetting = {
    enabled: boolean;
    clientId: string;
    clientSecret?: string;
    hasClientSecret: boolean;
...
export type WeChatSetting = SocialLoginSetting;
export type DouyinSetting = SocialLoginSetting;
...
export function getAdminWeChatSetting() {
    return http.get<{ setting: WeChatSetting }>("/admin/settings/wechat");
}

export function updateAdminWeChatSetting(input: Partial<WeChatSetting>) {
    return http.patch<{ setting: WeChatSetting }>("/admin/settings/wechat", input);
}

export function getAdminDouyinSetting() {
    return http.get<{ setting: DouyinSetting }>("/admin/settings/douyin");
}

export function updateAdminDouyinSetting(input: Partial<DouyinSetting>) {
    return http.patch<{ setting: DouyinSetting }>("/admin/settings/douyin", input);
}
...
export function updateAdminSMSSetting(input: Partial<SMSSetting> & { accessKeySecret?: string; apiKey?: string }) {
