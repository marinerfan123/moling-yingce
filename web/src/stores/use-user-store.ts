...
export function canUseCustomChannels(user: Pick<LocalUser, "role" | "status"> | null | undefined, featureEnabled: boolean) {
    return featureEnabled && user?.role === "admin" && user.status === "active";
}
