...
function setRuntime(desktopLocalChannelsEnabled, hostname) {
    userStore.useUserStore.setState({ user: { id: "admin", username: "admin", displayName: "Admin", role: "admin", status: "active" }, features: { ...userStore.defaultFeatureAvailability, desktopLocalChannelsEnabled } });
