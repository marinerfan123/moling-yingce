...
add({
  ...
  create: jsonCreate("/api/v3/images/generations", {
    ...
    response_format: coalesce(ref("request.providerOptions.volcengine-ark-image.response_format"), "url")
  }),
  response: { status: "succeeded", images: ref("response.data"), usage: ref("response.usage"), errorPaths: ["error.code"], messagePaths: ["error.message"], resultEphemeral: true }
});
